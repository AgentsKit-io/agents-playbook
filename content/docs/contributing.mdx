...
If your contribution is a ready-to-run agent rather than an engineering practice, submit it to the [AgentsKit Registry](https://registry.agentskit.io). If it improves the shared chat runtime, start with the [AgentsKit Chat documentation](https://chat.agentskit.io/docs) and its [machine-readable map](https://chat.agentskit.io/llms.txt). If it improves repository-to-agent documentation routing, start with the [Doc Bridge documentation](https://doc-bridge.agentskit.io/) and its [machine-readable map](https://doc-bridge.agentskit.io/llms.txt).

For a repeatable review of an agent-authored pull request before submission, use [AgentsKit Code Review](https://github.com/AgentsKit-io/code-review) and feed any reusable production lesson back into this Playbook.
