...
For the reusable framework boundary, see [AgentsKit Chat dogfood](/docs/agentskit-chat) and the canonical [Chat documentation](https://chat.agentskit.io/docs) or [machine-readable map](https://chat.agentskit.io/llms.txt). For repository routing and agent handoffs, use [Doc Bridge](https://agentskit-io.github.io/doc-bridge/) or its [machine-readable map](https://agentskit-io.github.io/doc-bridge/llms.txt).
