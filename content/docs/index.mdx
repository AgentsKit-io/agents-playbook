...
docbridge:
  covers:
    - package:@agentskit/playbook
  relations:
    - from: package:agents-playbook
      to: package:@agentskit/harness
      kind: depends-on
      detection: static
---
...
- [Code Review](https://code-review.agentskit.io/docs) — configurable, evidence-based code review
