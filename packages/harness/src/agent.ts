...
export interface SessionRecorder {
  ...
  failTool(input: { readonly actionId: string; readonly errorCode: string; readonly retryable: boolean; readonly durationMs: number }): HarnessEvent<'tool.failed'>
