...
console.log(JSON.stringify(failures.length ? { status: 'failed', criteria: ['benchmark-evidence'], failures } : { status: 'passed', criteria: ['benchmark-evidence'], observationCount: updated.observations.length }))
