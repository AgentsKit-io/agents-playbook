...
const manifest = resolve(root, 'benchmarks/harness-phase-2.json')
...
if (report?.manifest?.suiteId !== 'agentskit-harness-phase-2') failures.push('benchmark manifest was not loaded')
