...
const manifest = resolve(root, 'benchmarks/harness-phase-4.json')
...
if (report?.manifest?.suiteId !== 'agentskit-harness-phase-4') failures.push('benchmark manifest was not loaded')
