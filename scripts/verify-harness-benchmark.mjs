...
const manifest = resolve(root, 'benchmarks/harness-phase-0.json')
...
if (report?.manifest?.suiteId !== 'agentskit-harness-phase-0') failures.push('benchmark manifest was not loaded')
