...
const manifest = resolve(root, 'benchmarks/harness-phase-1.json')
...
if (report?.manifest?.suiteId !== 'agentskit-harness-phase-1') failures.push('benchmark manifest was not loaded')
