...
const config = {
  ...
  profile: 'strict',
  contract: { intent: 'Exercise the public CLI lifecycle.', scope: { inScope: ['fixture'], outOfScope: ['production'] }, ambiguities: [], outcomes: [{ id: 'package', statement: 'The public CLI reaches human approval.', checks: ['fixture-check'] }] },
...
try {
  ...
  console.log(JSON.stringify({ status: 'passed', criteria: ['package'], finalState: verified.state }))
} catch (error) {
